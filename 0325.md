...
![plot(iris ,-5 ,col=iris$Species)](https://user-images.githubusercontent.com/63720437/92330511-4884f100-f0aa-11ea-9044-2af19beb56e0.jpeg"plot(iris[,-5],col=iris$Species))
```r
# 1) type:선모양
dev.new()
par(mfrow=c(1,2))
